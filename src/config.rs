...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "132456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.ugediao.com"];
pub const RS_PUB_KEY: &str = "LCm2PiEtvwsyxjLvFVUcEs9AIqzArvSewv3C4vWjYCM=";
